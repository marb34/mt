...
/*Consultas*/
$query="
SELECT * FROM mantis_bug_table AS b, mantis_user_table AS u, mantis_bugnote_table AS bn, mantis_bugnote_text_table AS bnt
WHERE b.reporter_id=u.id AND b.id=bn.bug_id AND bn.bugnote_text_id=bnt.id AND u.username='$usuario1'";

$query1="
SELECT COUNT(*) total FROM mantis_bug_table AS b, mantis_user_table AS u, mantis_bugnote_table AS bn, mantis_bugnote_text_table AS bnt
WHERE b.reporter_id=u.id AND b.id=bn.bug_id AND bn.bugnote_text_id=bnt.id AND u.username='$usuario1' GROUP BY b.reporter_id";
